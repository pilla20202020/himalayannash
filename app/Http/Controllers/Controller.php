...
//        dd($request->hasFile('image'));
    ...
    public function uploadFromAjax(UploadedFile $file, $uploadPath, $width = 500, $height = 400, $nohash = false)
    {
        if (!is_dir('uploads'))
            mkdir('uploads');
    ...
    public function createThumb(File $image, $width = 500, $height = 400)
    {
        try{
