                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="2"
                                        ...
                                        <p>We have received a new inquiry for "<b>{{$data['package_name']}}</b>" from {{$data['email']}} with the following details. Please reply soon.</p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2"
                                        style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                                        <p>Please follow the link <a href="{{route('inquiry.index')}}">{{route('inquiry.index')}}</a> for more details.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
