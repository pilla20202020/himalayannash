...
@section('content')
<!--Breadcrumb-->
<section class="bannerimg banner-1 cover-image pt-9 pb-10 sptb-tab bg-background2" data-image-src="assets/images/Travel&tours/mountains-6043079_1920.jpg">
    <div class="header-text mb-0">
        <div class="container">
            <div class="row text-white">
                <div class="col">
                    <h1 class="">Header Style 04</h1>
                </div>
                <div class="col col-auto">
                    <ol class="breadcrumb text-center">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item active text-white" aria-current="page">Header Style 04</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-lg-8 col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="Everest Base Camp Trek" type="text" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="float-right mb-5 mb-lg-0">
                    <a href="#" class="btn btn-lg btn-primary">Submit Now</a>
                </div>
            </div>
